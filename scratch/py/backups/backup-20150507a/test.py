...
class Test(TransverseObjectInterface):
	def __constructor__(a:Int32):
		pass
	def echo(self, msg:UnicodeString) -> UnicodeString:
		pass
...
def testLoopbackTransport():
	...
	r1, r2 = Router(t1), Router(t2)
	sender = r1.defaultGateway
	receiver = r2.defaultGateway
	r2.exposeObjectImplementation(Test, TestImplementation)
	r2.exposeObjectImplementation(FilterAdd, FilterAddImplementation)
