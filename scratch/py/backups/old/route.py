...
class ObjectBroker:
	""" This class handles the mapping of object IDs to and from objects. It also handles the
	    exposure of objects through transverse identifiers. It does not handle the caching of
	    route-specific caching of transverse to object maps.
	"""
...
class Route(ObjectBroker):
	...
	def resolveTransverseID(self, transverseID):
		""" Resolves a transverse object identifier into the objectID of the associated
		    local object, if it has been exposed through this route).
		"""
		# return the exposed object associated with the transverse identifier
...
# Set-up all the default objects which all routes must support
